...
This repository contains projects on binary trees in C programming language. The goal is to learn about binary tree traversal, insertion, deletion, printing, coding of common algorithms, and implementing binary search trees.
...
- What are the depth, height, size, leaves of a binary tree
- What are the different types of traversals for a binary tree
- What is the main difference between insertion and deletion in a binary search tree

## Project Overview 

The project is divided into tasks that implement various binary tree operations and algorithms:

- 0-binary_tree_node.c: Definition of a binary tree node
...
- 7-binary_tree_inorder.c: Traverses using in-order traversal
- 8-binary_tree_postorder.c: Traverses using post-order traversal  
- 9-binary_tree_height.c: Measures the height of a binary tree
- 10-binary_tree_depth.c: Measures the depth of a node in a binary tree
- 11-binary_tree_size.c: Measures the size of a binary tree
- 12-binary_tree_leaves.c: Counts the leaves in a binary tree
- 13-binary_tree_nodes.c: Counts the nodes with at least 1 child in a BT
...
Each C file contains a main() function with sample test cases to verify functionality. Additional test files may be added in the future.
...
* __Naheemah Bello__ <[NaheemahBello](https://github.com/NaheemahBello)>
